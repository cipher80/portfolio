...
// // Example local fallback projects (replace with your real data or fetch from /api/projects)
// const FALLBACK_PROJECTS = [
//   {
//     title: "Digidot",
//     blurb:
//       "An Iot Project which Controlles smart devices through  C4,CRx controllers via connecting through Iot Bridges",
...
//     title: "Drify",
//     blurb:
//       "Liquor delivery app ,SaaS based project for USA - Includes Admin ,Vendor ,Rider and User Modules",
...
//   useEffect(() => {
//     // Example health & stats calls; implement these endpoints on your Node backend
//     fetch("/api/health")
//       .then((r) => {
//         setApiStatus(r.ok ? "up" : "down");
//       })
...
//                 I design and ship Node.js services with strong observability,
//                 security, and performance. From IoT bridges to payment
//                 flows—production-grade, end to end.
//               </p>
...
//                 </a>
//                 <a href="sandeeptiwari.jim.mca.2021@gmail.com" className="btn btn-outline">
//                   <Mail className="icon" /> Contact
//                 </a>
//               </div>
//             </motion.div>

//             {/* Right: portrait + signals */}
//             <motion.div
...
//             >
//               {/* Your photo — put /profile.jpg in client/public or use your path */}
...
//             <Cpu className="icon" /> <span>Core stack</span>
//           </div>
...
//         <div className="container">
//           <div className="badge-title" style={{ justifyContent: "space-between" }}>
//             <span style={{ display: "inline-flex", alignItems: "center", gap: ".5rem" }}>
//               <Code className="icon" /> Featured projects
//             </span>
//             <a
...
//                   )}
//                   {p.links?.code && (
//                     <a className="link" href={p.links.code}>
...
//               <div className="muted">
//                 I can help with API design, distributed jobs, observability, and
//                 DevOps.
//               </div>
//             </div>
...
//               </a>
//               <a
//                 href="https://cal.com/yourname/intro"
...
// /** Inline SVGs (sized by .icon class via CSS) */
    ...
    <div className="hero-layout">
      ...
      >
        <div className="avatar-frame">
          <img
            src="src/sandeep.jpeg"            /* place this in client/public */
            alt="Sandeep Tiwari"
            loading="eager"
            onError={(e)=>{ e.currentTarget.style.visibility='hidden'; }}
          />
